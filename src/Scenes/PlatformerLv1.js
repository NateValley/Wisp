class PlatformerLv1 extends Phaser.Scene {
    constructor() {
        super("platformerLv1Scene");
    }
    ...
    create() {
        ...
        this.map = this.add.tilemap("wisp_level1", 16, 16, 96, 18);
    ...
    // PLAYER VARIABLES
        ...
        my.vfx.walking = this.add.particles(0, 0, 'particle_1', {
            // frame: ['particle_1', 'particle_2'], //is causing warnings
